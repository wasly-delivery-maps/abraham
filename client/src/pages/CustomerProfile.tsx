      ...
      <div className="bg-slate-900 text-white pt-12 pb-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex justify-between items-center mb-12">
            <Button 
              variant="ghost" 
              className="text-white/80 hover:text-white hover:bg-white/10 rounded-2xl h-12 px-4 flex items-center gap-2 transition-all"
              onClick={() => navigate("/customer/dashboard")}
            >
              <ChevronLeft className="h-5 w-5 rotate-180" />
              <span className="font-bold text-sm">رجوع</span>
            </Button>
            <h1 className="text-xl font-black tracking-widest uppercase hidden sm:block">الملف الشخصي</h1>
            <Button 
              variant="ghost" 
              className="text-white/80 hover:text-rose-400 hover:bg-rose-500/10 rounded-2xl h-12 px-4 flex items-center gap-2 transition-all"
