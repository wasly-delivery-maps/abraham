  ...
  orders: router({
    ...
    createRestaurantOrder: protectedProcedure
      ...
      .mutation(async ({ ctx, input }) => {
        ...
        // We'll define a fallback menu map for items that might not be in the DB yet
        const fallbackMenu: Record<number, string> = {
          // Khedive Koshary
          101: "علبة كمالة 🥣", 102: "علبة صغيرة 🥣", 103: "علبة الخديوي 👑", 104: "لوكس الخديوي ✨",
          105: "سوبر الخديوي 🔥", 106: "أسبيشيال الخديوي 🌟", 107: "وليمة الخديوي 🥘", 108: "جامبو الخديوي 🐘",
          109: "طاجن عادة 🥘", 110: "طاجن لحمة 🥩", 111: "طاجن سجق 🌭", 112: "طاجن كبدة 🥘",
          113: "طاجن فراخ 🍗", 114: "طاجن خضار 🥦", 115: "طاجن وايت صوص 🥛", 116: "طاجن لحمة وايت صوص 🥩",
          117: "طاجن سجق وايت صوص 🌭", 118: "طاجن فراخ وايت صوص 🍗", 119: "طاجن جمبري 🍤", 120: "طاجن مشروم 🍄",
          121: "موتزاريللا سادة 🧀", 122: "موتزاريللا لحمة 🥩", 123: "موتزاريللا كبدة 🥘", 124: "موتزاريللا سجق 🌭",
          125: "موتزاريللا فراخ 🍗", 126: "موتزاريللا خضار 🥦", 127: "ميكس عادة 🥘", 128: "ميكس لحمة 🥩",
          129: "ميكس سجق 🌭", 130: "ميكس كبدة 🥘", 131: "ميكس فراخ 🍗", 132: "حواوشي سادة 🥙",
          133: "حواوشي سجق 🌭", 134: "حواوشي بسطرمة 🥩", 135: "حواوشي هالبينو 🌶️", 136: "حواوشي ميكس تركي 🥙",
          137: "أرز باللبن سادة 🍚", 138: "أرز باللبن فرن 🍮", 139: "أرز باللبن مكسرات 🥜", 140: "أرز باللبن كنافة 🍯",
          141: "أرز باللبن لوتس 🍪", 142: "أرز باللبن مانجو 🥭", 143: "قنبلة بسبوسة 💣", 144: "قنبلة فراولة 🍓",
          145: "شوكليت كيك 🍰", 146: "ديسباسيتو 🍫", 147: "أم علي 🥣", 148: "دقة 🍶", 149: "شطة 🌶️",
          150: "عدس 🥣", 151: "حمص 🥜", 152: "تقلية 🧅", 153: "صلصة 🍅", 154: "سلطة 🥗", 155: "عيش لبناني 🍞", 156: "موتزاريللا 🧀",
          // Al-Hout
          301: "شوربة كريمة 🥣", 302: "شوربة جمبري حمراء 🥣", 303: "شوربة صيامي 🥣", 304: "ملوخية بالجمبري 🥘",
          315: "مكرونة وايت صوص (سي فود / جمبري) 🍝", 316: "مكرونة ريد صوص (سي فود / جمبري) 🍝", 317: "كابوريا إسكندراني 🦀", 318: "فيليه (وايت صوص / ريد صوص) 🐟",
          319: "سمك بلطي 🐟", 320: "سمك بوري 🐟", 321: "سمك ماكريل 🐟", 322: "فيليه قشر بياض 🐟", 323: "سمك مكرونة 🐟",
          324: "سمك دنيس 🐟", 325: "سمك لوت 🐟", 326: "سبيط بلدي 🦑", 327: "كالماري 🦑", 328: "بلح بحر 🐚", 329: "جندوفلي 🐚", 330: "جمبري قشر إسكندراني 🍤",
          // Roll We / Wasly
          1001: "بيتزا فراخ صغير 🍕", 1002: "بيتزا فراخ كبير 🍕", 1003: "بيتزا جبن صغير 🍕", 1004: "بيتزا جبن كبير 🍕",
          1005: "بيتزا مارغريتا صغير 🍕", 1006: "بيتزا مارغريتا كبير 🍕", 1007: "بيتزا كفتة صغير 🍕", 1008: "بيتزا كفتة كبير 🍕",
          1009: "بيتزا سجق صغير 🍕", 1010: "بيتزا سجق كبير 🍕", 1011: "بيتزا استربس صغير 🍕", 1012: "بيتزا استربس كبير 🍕",
          1013: "بيتزا شيش صغير 🍕", 1014: "بيتزا شيش كبير 🍕", 1015: "بيتزا برجر صغير 🍕", 1016: "بيتزا برجر كبير 🍕",
          1017: "بيتزا شاورما صغير 🍕", 1018: "بيتزا شاورما كبير 🍕", 1019: "بيتزا مكس فراخ صغير 🍕", 1020: "بيتزا مكس فراخ كبير 🍕",
          1021: "بيتزا مكس جبن صغير 🍕", 1022: "بيتزا مكس جبن كبير 🍕", 1023: "بيتزا فراخ رانش صغير 🍕", 1024: "بيتزا فراخ رانش كبير 🍕",
          1025: "كريب استربس عادي 🌯", 1026: "كريب استربس سوبر 🌯", 1027: "كريب بانيه عادي 🌯", 1028: "كريب بانيه سوبر 🌯",
          1029: "كريب كفتة عادي 🌯", 1030: "كريب كفتة سوبر 🌯", 1031: "كريب برجر عادي 🌯", 1032: "كريب برجر سوبر 🌯",
          1033: "كريب سجق عادي 🌯", 1034: "كريب سجق سوبر 🌯", 1035: "كريب بطاطس عادي 🌯", 1036: "كريب بطاطس سوبر 🌯",
          1037: "كريب زنجر عادي 🌯", 1038: "كريب زنجر سوبر 🌯", 1039: "كريب جبن عادي 🌯", 1040: "كريب جبن سوبر 🌯",
          1041: "كريب شيش سوبر 🌯", 1042: "وجبة كفتة 🍱", 1043: "وجبة شيش 🍱", 1044: "وجبة ميكس 🍱", 1045: "استربس بانيه 🥗",
          1046: "استربس بطاطس 🥗", 1047: "استربس شيش 🥗", 1048: "بانيه بطاطس 🥗", 1049: "شيش بطاطس 🥗", 1050: "شيش شاورما 🥗",
          1051: "شيش برجر 🥗", 1052: "نجرسكو فراخ ع الفحم 🍝", 1053: "نجرسكو فراخ ع الفحم ك 🍝", 1054: "نجرسكو لحوم 🍝",
          1055: "نجرسكو جبن 🍝", 1056: "فرخة مشوية كاملة 🍗", 1057: "نص فرخة 🍗", 1058: "ربع فرخة ورك 🍗", 1059: "ربع فرخة صدر 🍗",
          1060: "ساندوتش كفتة 🥖", 1061: "ساندوتش شيش 🥖", 1062: "ساندوتش حواوشي 🥙", 1063: "ساندوتش برجر 🍔", 1064: "ساندوتش رانش 🍔",
          1065: "ساندوتش زنجر 🍔", 1066: "باكت بطاطس 🍟", 1067: "سلطة 🥗"
        };
